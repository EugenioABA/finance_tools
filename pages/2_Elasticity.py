...
ax1.text(price_1, quantity_1, f'  Q1 = {quantity_1}', verticalalignment='bottom', horizontalalignment='right', fontsize=12)
ax1.text(price_2, quantity_2, f'  Q2 = {quantity_2}', verticalalignment='bottom', horizontalalignment='right', fontsize=12)
ax1.xaxis.set_major_locator(MaxNLocator(integer=True, nbins=10))
ax1.yaxis.set_major_locator(MaxNLocator(integer=True, nbins=10))
ax1.set_title('Demand Curve', fontsize=28)
ax1.set_xlabel('Price', fontsize=20)
ax1.set_ylabel('Quantity Demanded', fontsize=20)
ax1.grid(True)
ax1.legend()
...
ax2.text(price_1, price_1 * quantity_1, f'  TR1 = ${price_1 * quantity_1:.2f}', verticalalignment='bottom', horizontalalignment='right', fontsize=12)
ax2.text(price_2, price_2 * quantity_2, f'  TR2 = ${price_2 * quantity_2:.2f}', verticalalignment='bottom', horizontalalignment='right', fontsize=12)
...
ax2.set_title('Revenue Curve', fontsize=28)
ax2.set_xlabel('Price', fontsize=20)
ax2.set_ylabel('Total Revenue', fontsize=20)
ax2.grid(True)
ax2.legend()
